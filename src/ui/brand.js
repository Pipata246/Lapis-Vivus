...
export const BTN = {
  ru: {
    ...
    oracle: 'Оракул',
    oracleOpenChat: 'Открыть чат',
    oracleHistory: 'История чатов',
    oracleNewChat: 'Новый чат',
    oraclePast: 'Прошлые вопросы',
    oracleDelete: 'Удалить',
  ...
  en: {
    ...
    oracle: 'Oracle',
    oracleOpenChat: 'Open chat',
    oracleHistory: 'Chat history',
    oracleNewChat: 'New chat',
    oraclePast: 'Previous questions',
    oracleDelete: 'Delete',
