...
function buildBlockMandate(block, blockIndex) {
  ...
  return [
    ...
    '  • "suggested_prompts" — массив из 2-3 вопросов (до 40 символов каждый)',
    '',
    'ПРИМЕРЫ suggested_prompts:',
    '  ["Как применить это?", "Расскажи подробнее", "Что делать дальше?"]',
    '  ["Как работать с этим?", "Что означает дефицит?", "Как усилить?"]',
    '',
